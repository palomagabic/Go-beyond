...
ActiveRecord::Schema.define(version: 2020_07_09_211335) do
  ...
  create_table "scrapbooks", force: :cascade do |t|
    ...
    t.datetime "image_updated_at"
    t.bigint "users_id"
    t.index ["users_id"], name: "index_scrapbooks_on_users_id"
  end
  ...
  add_foreign_key "scrapbooks", "users", column: "users_id"
end
